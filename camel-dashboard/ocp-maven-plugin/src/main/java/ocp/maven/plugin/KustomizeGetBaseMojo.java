...
import ocp.maven.plugin.kustomize.KustomizeGetBaseCommand;

@Mojo(name = "pull-base", defaultPhase = LifecyclePhase.DEPLOY)
public class KustomizeGetBaseMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        new KustomizeGetBaseCommand.Builder(project, overlay, application)
                .wait(wait)
                .build()
                .prepareForExecution()
                .execute();
