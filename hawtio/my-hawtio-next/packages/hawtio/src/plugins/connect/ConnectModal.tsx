...
export const ConnectModal: React.FunctionComponent<ConnectModalProps> = props => {
  ...
  const test = async () => {
    ...
    console.log("=============>>>>>>>>>>>Testing jolokia status00000000000000: ");
    // try {
    //   const res2 = await axios({
    //     method: 'get',
    //     url: 'https://s2i-odr-integrator-s2i-sandbox.apps.dev-ocp4.ist.sus.ebc.gov.on.ca:443/actuator/hawtio/jolokia/version',
    //   });
    //    console.log("=============>>>>>>>>>>> jolokia status00000000000000: ");
    // } catch (error) {
    //   console.log("=============>>>>>>>>>>> error000000: ", String(error));
    // }
