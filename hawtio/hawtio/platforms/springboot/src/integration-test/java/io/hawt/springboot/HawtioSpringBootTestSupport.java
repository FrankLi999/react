...
public class HawtioSpringBootTestSupport {
    // TODO
    public static final int SERVER_PORT = 0; // SocketUtils.findAvailableTcpPort();
    public static final int MANAGEMENT_PORT = 0; // SocketUtils.findAvailableTcpPort(SERVER_PORT + 1);
