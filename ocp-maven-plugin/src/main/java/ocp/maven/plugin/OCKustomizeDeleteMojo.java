...
import ocp.maven.plugin.kustomize.OCDeleteCommand;

@Mojo(name = "delete", defaultPhase = LifecyclePhase.INSTALL)
public class OCKustomizeDeleteMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        new OCDeleteCommand.Builder(project, overlay, application)
                .wait(wait)
                .build()
                .prepareForExecution()
                .execute();
