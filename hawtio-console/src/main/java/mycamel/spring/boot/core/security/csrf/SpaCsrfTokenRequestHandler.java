package mycamel.spring.boot.core.security.csrf;
...
final public class SpaCsrfTokenRequestHandler extends CsrfTokenRequestAttributeHandler {
	...
	public String resolveCsrfTokenValue(HttpServletRequest request, CsrfToken csrfToken) {
		 ...
		 * XorCsrfTokenRequestAttributeHandler to resolve the CsrfToken. This applies when
		 * a server-side rendered form includes the _csrf request parameter as a hidden
		 * input.
		 */
