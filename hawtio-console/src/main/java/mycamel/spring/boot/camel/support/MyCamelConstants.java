...
public class MyCamelConstants {

	public static final String MDC_MY_CAMEL_TRACE_ID = "my_camel_trace_id";

	public static final String MDC_MY_CAMEL_ROUTE_ID = "my_camel_route_id";
