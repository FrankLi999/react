package io.hawt.example.spring.boot.camel.routes.bean;

import com.fasterxml.jackson.core.JsonProcessingException;
import io.hawt.example.spring.boot.camel.dto.*;
import io.hawt.example.spring.boot.camel.routes.config.RefreshConfigService;
