...
public class CamelRequestContextHolder {
    private static final ThreadLocal<ApiRequestClientRequestContext> camelRequestContextHolder = new NamedInheritableThreadLocal<>("Camel request Context");

    public static void setApiRequestClientRequestContext(ApiRequestClientRequestContext apiRequestClientRequestContext) {
