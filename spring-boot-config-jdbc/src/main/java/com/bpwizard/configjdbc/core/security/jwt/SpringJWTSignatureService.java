 ...
 */
public class SpringJWTSignatureService extends AbstractJwtService implements JWTSignatureService {

    private JWSSigner signer;
    private JWSVerifier verifier;

    public SpringJWTSignatureService(String secret) throws JOSEException {
