 ...
 */
public class SpringJWTEncryptionService extends AbstractJwtService implements JWTEncryptionService {
    ...
    public SpringJWTEncryptionService(String secret) throws KeyLengthException {
